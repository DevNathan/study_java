...
//		menu1 = sc.nextInt();
		...
		while (menu1 != 5) {
			...
			menu1 = sc.nextInt();
			switch (menu1) {
			case 1 : result = print1; 	System.out.println(result); break;
			case 2 : result = print2;	System.out.println(result); break;
			case 3 : result = print3;	System.out.println(result); break;
			case 4 : result = print4;	System.out.println(result); break;
			case 5 : break;
